...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var b = sum(a, sumArr[2])[0];
  var str = `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${b} is their sum.`;
...
function multiplyArray(multArr) { //eslint-disable-line
  var a = multiply(multArr[0], multArr[1])[0];
  var b = multiply(a, multArr[2])[0];
  var str = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${b}.`
